...
| 11 | D13 | La NetworkPolicy coupe Traefik : cause non établie, donc non appliquée | — | k8s/reseau.yaml reste au dépôt, non appliqué, avec ce qui a été mesuré en tête de fichier. | Elle devait fermer le scénario de D1 — joindre le pod sur 8080 sans passer par Traefik ni son Basic Auth. Avec elle, les chemins machine rendent 502 ; sans elle, 200 et 401. Le pod porte la bonne étiquette, kube-system porte la sienne, Traefik n'est pas en hostNetwork, et ouvrir le réseau des nœuds n'a rien changé. On ne déploie pas un garde-fou dont on ne comprend pas le comportement. |
